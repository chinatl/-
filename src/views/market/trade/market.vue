...
<!--表格-->
    ...
    <el-table :key='tableKey' :data="list" border fit highlight-current-row
      style="width: 100%;margin-top:20px">
			<el-table-column align="center" label="英文名称" width="100">
					<template slot-scope="scope">
					  <span>{{scope.row.shortName + '_' + scope.row.basisV}}</span>
					</template>
</el-table-column>
...
<el-table-column align="center" label="买出手续费">
	<template slot-scope="scope">
...
<el-dialog :title="title" :visible.sync="show_dialog">
	<el-form ref="dataForm" label-position="right" label-width="140px" style='width: 400px; margin-left:50px;'>
		...
		<el-form-item label="市场标题：" prop="type">
			<el-select style="width:200px" v-model="form.isStart">
				<el-option label="开启" value="0"></el-option>
				<el-option label="关闭" value="1"></el-option>
			</el-select>
		</el-form-item>
		<el-form-item label="市场图片：" prop="type">
		...
		<el-form-item label="昨日收盘价：" prop="type">
			<el-input v-model='form.email'></el-input>
		</el-form-item>
		...
		<el-form-item label="交易状态：" prop="type">
			<el-select style="width:200px" v-model="form.tradeType">
				<el-option label="开启交易" value="0"></el-option>
				<el-option label="关闭交易" value="1"></el-option>
			</el-select>
		</el-form-item>
		<el-form-item label="买家赠送：" prop="type">
			<el-select style="width:200px" v-model="form.buySendState">
				<el-option label="允许赠送" value="0"></el-option>
				<el-option label="允许赠送" value="1"></el-option>
			</el-select>
		</el-form-item>
		<el-form-item label="卖家赠送：" prop="type">
			<el-select style="width:200px" v-model="form.sellSendState">
				<el-option label="允许赠送" value="0"></el-option>
				<el-option label="允许赠送" value="1"></el-option>
			</el-select>
		</el-form-item>
		...
		data() {
			return {
				form: {
					...
					tradeType: "", //交易状态（0：开启，1：关闭）
					buySendState: "", //在家赠送是否开启（0：开启、1：关闭）
					sellSendState: "", //卖家赠送是否开启（0：开启、1：关闭）
					buySendCurrId: "", //买家赠送币种ID
					sellSendCurrId: "", //卖家赠送币种ID
					buySendScaleSelf: "", //买家自己赠送比例
					buySendScale1: "", //买家一代赠送比例
					buySendScale2: "", //买家二代赠送比例
					buySendScale3: "", //买家三代赠送比例
					sellSendScaleSelf: "", //卖家自己赠送比例
					sellSendScale1: "", //卖家一代赠送比例
					sellSendScale2: "", //卖家二代赠送比例
					sellSendScale3: "", //卖家三代赠送比例
				},
				type: 'add',
				title: '数据添加',
				show_dialog: false,
		...
		methods: {
			init() {
				Get({
					url: 'currencyManage/findAll',
					data: {
						tradeType: this.listQuery.isStart,
						pageNo: this.listQuery.pageNo,
						shortName: this.listQuery.shortName,
						basisV: this.listQuery.basisV,
