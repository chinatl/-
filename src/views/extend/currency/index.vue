...
<el-dialog :title="title" :visible.sync="show_dialog">
	<el-form ref="dataForm" label-position="right" label-width="180px" style='width: 400px; margin-left:50px;'>
		...
		<el-form-item label="币种类型：" prop="type">
			<el-select v-model="form.currencyType" placeholder="全部类型" style='width:240px'>
		...
		<el-form-item label="状态：" prop="type">
			<el-select v-model="form.vStatus" placeholder="状态" style='width:240px'>
		...
		<el-form-item label="是否可以提现：" prop="type">
			<el-select v-model="form.isWithdrawal" placeholder="状态"  style='width:240px'>
				<el-option label="是" value="0"></el-option>
				<el-option label="否" value="1"></el-option>
			</el-select>
		</el-form-item>
		<el-form-item label="是否可以充值：" prop="type">
			<el-select v-model="form.isTtopUp" placeholder="状态"  style='width:240px'>
				<el-option label="是" value="0"></el-option>
				<el-option label="否" value="1"></el-option>
			</el-select>
		</el-form-item>
		...
		<el-form-item label="是否开启充值赠送：" prop="type">
			<el-select v-model="form.isTopUpGiving" placeholder="状态"  style='width:240px'>
				<el-option label="是" value="0"></el-option>
				<el-option label="否" value="1"></el-option>
			</el-select>
		</el-form-item>
		...
		<el-form-item label="要赠送的币种：" prop="type">
			<el-select v-model='form.topUpVirtualCurrency'  style='width:240px'>
